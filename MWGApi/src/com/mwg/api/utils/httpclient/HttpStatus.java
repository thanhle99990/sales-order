...
public enum HttpStatus {
  ...
  OK(200, "OK", "The request sent by the client was successful."), Created(201, "Created", "The request was successful and the resource has been created."),
  ...
  BadRequest(400, "Bad Request", "The request could not be understood by the server."), Unauthorized(401, "Unauthorized", "The request requires authorization."),
  ...
  NotFound(404, "Not Found", "The requested resource was not found."), MethodNotAllowed(405, "Method Not Allowed", "The supplied method was not allowed on the given resource."),
